...
processed_data = {'LWP_mean': [], 'LWP_std':[], 'LWP_median':[], 'LWP_skewness':[],\
                  'CDNC_mean':[], 'CDNC_std':[],\
                  'CDNC_median':[], 're_mean':[],'CF_mean':[], \
                  'CF_MODIS_mean':[], 'reflectance':[], 'f_name':[],\
...
for k in all_data.keys():
    ...
    processed_data['reflectance'] = np.append(processed_data['reflectance'], all_data[k]['reflectance'])
...
plt.figure(); plt.scatter(processed_data['LWP_std'][CF_mask]/processed_data['LWP_mean'][CF_mask], processed_data['reflectance'][CF_mask], c=processed_data['CF_MODIS_mean'][CF_mask], cmap='jet', vmax=1)
plt.colorbar()
plt.xlim([-5,5]); plt.ylim(0,0.8);


CF_mask = [(processed_data['CF_mean'] > 0.5) *
           (processed_data['CF_mean'] <=1 )][0]
plt.figure(); plt.scatter(processed_data['LWP_skewness'][CF_mask], processed_data['reflectance'][CF_mask]*processed_data['CF_MODIS_mean'][CF_mask], c=processed_data['LWP_mean'][CF_mask], cmap='jet', vmax=50)
plt.colorbar()
plt.xlim([-5,5]); plt.ylim(0,0.8);
